...
<meta  name="viewport" content="width=device-width, initial-scale=1"/>
  <section class="top-nav">
    <div>
        ...
        <img  style={{ width:'70px', height:'auto', marginLeft:"-30px" }} src={headerlogo} />
        </div>
    </div>
    ...
    <ul class="menu">
     <li > <a style={{color:"#fff"}} onClick={() => navigate("/ZombiePage")}>Zombie Mint</a></li>
      <li> <a style={{color:"#fff"}} onClick={() => navigate("/StakingPage")}>Staking Old</a> </li>
      <li> <a style={{color:"#fff"}} onClick={() => navigate("/StakingPageNew")}> Staking New</a></li> 
      <li>
